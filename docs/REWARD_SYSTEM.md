...
| [`Services/BookBoxPoolRules.cs`](../../Assets/Game/Features/Rewards/Services/BookBoxPoolRules.cs) | Хардкод-таблица правил pool-selection: general boxes (`book_box_general_5`, `book_box_general_10`, `book_box_common_15`, `book_box_rare_8`) and genre boxes (`book_box_genre_<genre>_8` for every `BookGenre`, plus tutorial-only `book_box_genre_heartfelt_1`). Phase 2+: вынести в config. |
