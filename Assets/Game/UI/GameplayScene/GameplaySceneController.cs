...
public class GameplaySceneController : WindowController<GameplaySceneView>, IDataReadyWindow
{
    ...
    private ITutorialTargetRegistry _tutorialTargets;
    ...
    public void Construct(
        ...
        ITutorialTargetRegistry tutorialTargets = null,
    ...
    {
        _tutorialTargets?.Register(TutorialTargetIds.HubStartDayButton, View?.StartDayTargetRect);
    }

    private void UnregisterTutorialTargets()
    {
        _tutorialTargets?.Unregister(TutorialTargetIds.HubStartDayButton, View?.StartDayTargetRect);
    }
