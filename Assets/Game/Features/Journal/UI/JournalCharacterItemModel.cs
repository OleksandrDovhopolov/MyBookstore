...
namespace Game.Journal.UI
{
    ...
    public sealed class JournalCharacterItemModel
    {
        public JournalCharacterItemModel(string characterId, string displayNameKey, string roleKey,
            ...
            IReadOnlyList<string> favoriteGenres, IReadOnlyList<JournalMemoryItemModel> memories)
        {
            ...
            FavoriteGenres = favoriteGenres ?? System.Array.Empty<string>();
        ...
        public IReadOnlyList<string> FavoriteGenres { get; }
