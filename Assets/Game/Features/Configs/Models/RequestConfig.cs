namespace Game.Configs.Models
{
    ...
    public sealed class RequestConfig : IConfig
    {
        ...
        /// <summary>Desired book qualities (+2 per match).</summary>
        public string[] DesiredQualities { get; set; }
        ...
        /// <summary>Bonus gold on top of the fixed book price when the recommendation tier is Excellent.</summary>
