...
{
    /// <summary>
    /// In-memory ISaveService with honest JSON round-trip. Tracks registered hooks for assertions
    /// in the inventory tests (e.g., InventoryService self-registration).
    /// </summary>
