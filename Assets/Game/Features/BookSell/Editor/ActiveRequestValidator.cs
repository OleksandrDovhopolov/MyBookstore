...
{
    /// <summary>
    /// Checks every active request in hard_requests.json against the whole books.json catalog and reports
    ...
    public static class ActiveRequestValidator
    {
        ...
        public const string RequestsPath = "Assets/Configs/hard_requests.json";
