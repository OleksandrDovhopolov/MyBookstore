...
namespace Book.Sell.Domain
{
    ...
    /// <see cref="MatchedGenres"/>/<see cref="MatchedQualities"/> are the demand-match passthrough used to build
    ...
    public sealed class PassiveAttemptResult
    {
        ...
        private PassiveAttemptResult(
            ...
            IReadOnlyList<string> matchedGenres, IReadOnlyList<string> matchedQualities)
        {
        ...
        public static PassiveAttemptResult Hit(
            ...
            IReadOnlyList<string> matchedGenres = null, IReadOnlyList<string> matchedQualities = null)
            => new(genre, true, book, matchedGenres, matchedQualities);
